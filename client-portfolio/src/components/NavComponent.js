        ...
        <ul>
          <div className="portfolio-dp">
            ...
            <div className="portfolio-content" id="pfc">
              <a className="dp-link" href="/graduation">
                Graduation
              </a>
              <a className="dp-link" href="/portrait">
                Portrait
              </a>
              <a className="dp-link" href="/sport">
                Sport
              </a>
            </div>
          </div>
          <div className="info-dp">
            ...
            <div className="info-content" id="ic">
              <a className="dp-link" href="/investment">
                Investment
              </a>
              <a className="dp-link" href="/testimonials">
                Testimonials
              </a>
              <a className="dp-link" href="/faq">
                FAQ
              </a>
              <a className="dp-link" href="/booking">
                Booking
              </a>
            </div>
          </div>
